...
- **366 Vitest unit/component tests** passing (`npm test`); strict typecheck + production build green.
...
`npm test` runs **366 Vitest unit/component tests** (includes co-located
