...
- **358 Vitest unit/component tests** passing (`npm test`); strict typecheck + production build green.
...
`npm test` runs **358 Vitest unit/component tests** (includes co-located
