...
- **357 Vitest unit/component tests** passing (`npm test`); strict typecheck + production build green.
...
`npm test` runs **357 Vitest unit/component tests** (includes co-located
