...
> [`REWARDS-PLAN.md`](REWARDS-PLAN.md). Maintainer preferences, assistant conventions, and
> iOS/deploy/IndexedDB gotchas are in [`COLLAB-NOTES.md`](COLLAB-NOTES.md). New session
> continuing that work: start from those two files.
